  ...
  return <div className="settings-page">
    ...
    <section className="panel settings-card">
      ...
      <div className="settings-section"><h2>Озвучка</h2><p className="section-note">Edge TTS остаётся бесплатным провайдером по умолчанию. Lumean подключается по API.</p>
        ...
        <label className="settings-field">Lumean ID шаблона TTS<input value={settings.lumeanTemplateId || ''} onChange={e => update('lumeanTemplateId', e.target.value)} placeholder="Необязательно — возьмётся первый шаблон из кабинета" /><small>Ваши шаблоны Lumean появятся в списке голосов на Столе; это поле нужно только чтобы выбрать шаблон-основу для голосов из библиотеки ElevenLabs</small></label>
      </div>
